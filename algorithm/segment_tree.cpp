...
#define eps 1e-11
#define len(x) x.size()
#define FIN freopen("/home/sazid/workspace/clion_default_project/input.txt", "r", stdin);
#define FOUT freopen("/home/sazid/workspace/clion_default_project/output.txt", "w", stdout);
#define NL "\n"
#define mx 100001
