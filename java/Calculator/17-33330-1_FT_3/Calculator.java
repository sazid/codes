...
public class Calculator extends JFrame implements ActionListener {
    ...
    private void initButtonPanel() {
        ...
        btn_0 = new CalcButton("res/0", "png");
        btn_1 = new CalcButton("res/1", "png");
        btn_2 = new CalcButton("res/2", "png");
        btn_3 = new CalcButton("res/3", "png");
        btn_4 = new CalcButton("res/4", "png");
        btn_5 = new CalcButton("res/5", "png");
        btn_6 = new CalcButton("res/6", "png");
        btn_7 = new CalcButton("res/7", "png");
        btn_8 = new CalcButton("res/8", "png");
        btn_9 = new CalcButton("res/9", "png");
        btn_dot = new CalcButton("res/dot", "png");
        btn_add = new CalcButton("res/plus", "png");
        btn_subtract = new CalcButton("res/minus", "png");
        btn_multiply = new CalcButton("res/multiply", "png");
        btn_divide = new CalcButton("res/divide", "png");
        btn_equals = new CalcButton("res/equals", "png");
        btn_clear = new CalcButton("res/clear", "png");
        btn_root = new CalcButton("res/root", "png");
